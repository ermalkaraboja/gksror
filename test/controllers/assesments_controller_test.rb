...
class AssesmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assesment" do
    assert_difference('Assesment.count') do
      post assesments_url, params: { assesment: { title: @assesment.title, weight: @assesment.weight } }
    end
  ...
  test "should update assesment" do
    patch assesment_url(@assesment), params: { assesment: { title: @assesment.title, weight: @assesment.weight } }
